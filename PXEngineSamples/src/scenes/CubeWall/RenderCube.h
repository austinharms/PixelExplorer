#ifndef PXENGINESAMPELS_SCENES_CUBEWALL_RENDER_CUBE_H_
#define PXENGINESAMPELS_SCENES_CUBEWALL_RENDER_CUBE_H_
#include <new>
...
#endif // !PXENGINESAMPELS_SCENES_CUBEWALL_RENDER_CUBE_H_