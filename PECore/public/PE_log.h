...
namespace pecore {
    ...
    PE_API void PE_CALL PE_InitLog();
    // Aborts the application
    PE_NORETURN PE_API void PE_CALL PE_LogCriticalAbort();
}

// TODO Replace this with custom log implmentation
...
#define PE_LogCritical(category, fmt, ...) do { SDL_LogCritical(category, fmt, __VA_ARGS__); pecore::PE_LogCriticalAbort(); } while(false)
